 ...
 * Frontend modules
 */
$GLOBALS['TL_DCA']['tl_module']['palettes'][LinkListingController::TYPE] = '{title_legend},name,headline,type;{category_legend},links_categories;{template_legend},links_sortBy,links_template,customTpl;{image_legend:hide},imgSize;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
